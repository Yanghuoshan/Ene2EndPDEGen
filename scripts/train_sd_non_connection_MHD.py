...
def train(hp):
    ...
    # Optional init-from-checkpoint (start fresh run but load model weights)
    ...
    # Optionally initialize model weights from another checkpoint but start a fresh training run.
