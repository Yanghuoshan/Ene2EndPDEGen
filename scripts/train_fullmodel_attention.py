...
from src.models_v21 import FullModel_Attention
...
def train(hp):
    # Enable TF32 for Ampere Tensor Cores
    ...
    print("Using FullModel_Attention Architecture")
    model = FullModel_Attention(
        t_chunk=T_CHUNK,
        channel_in=C_OUT,
        channel_out=C_OUT,
        coord_dim=2,
