...
def train(hp):
    ...
    print("Starting End-to-End Training (Data-Space Supervision) ...")
    ...
    for epoch in epoch_pbar:
        ...
        print(f"\nEpoch {epoch+1}/{EPOCHS} Average Loss: {avg_loss:.6f} | GradNorm Enc: {avg_gnorm_enc:.4f} | GradNorm CNF: {avg_gnorm_cnf:.4f}")
