...
from src.dataset import OpenFOAMVelocityChunkDataset
...
def train(hp):
    ...
    try:
        ...
        dataset = OpenFOAMVelocityChunkDataset(
            dataset_path=DATASET_PATH,
            chunk_size=T_CHUNK,
            stride=STRIDE,
            mode='train',
            downsample_factor=getattr(hp, "downsample_factor", 1)
        )
