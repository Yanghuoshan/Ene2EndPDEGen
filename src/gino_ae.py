...
from src.modules.integral_transform import IntegralTransform, MLPLinear
from src.modules.neighbor_search import NeighborSearch
from src.modules.embedding import FourierEmb
from src.cnn_ae import CNN_Encoder, CNN_Decoder
        ...
        if b > 1:
            ...
            for i in range(b):
                ...
                if pad_mask is not None:
                    ...
                    max_length = output_queries_batch.shape[2]
